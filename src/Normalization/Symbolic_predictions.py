...
def initialize(input_config):
    ...
    return prefix, rules_path, rdf_path, kg_path, predictions_folder, constraints_folder, kg_name, pca_threshold
...
if __name__ == '__main__':
    try:
        ...
        #MAX logger.info(f"Starting symbolic prediction process with config: {input_config}")

        #Initializaing from the input.json file
        prefix, rules_path, rdf_path, kg_path, predictions_folder, constraints_folder, kg_name, pca_threshold = initialize(input_config)
        ...
        # result_df, enriched_kg = process_rules(rulesfile, prefix, rdf_path, predictions_folder, kg_name, pca_threshold)
        ...
        transform(g,constraints_folder, kg_name)
